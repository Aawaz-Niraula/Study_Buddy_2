 ...
 *  the Dress-Up Room when tapped. */
export function FloatingMascot() {
  const { design, color, mood, openDressUp, playBoop } = useMascot();
  ...
  return (
    <motion.button
      ...
      aria-label="Open Aawax"
      className="fixed bottom-[84px] right-4 z-30 flex h-14 w-14 items-center justify-center rounded-full border border-white/10 bg-[#0d0d15]/80 backdrop-blur-md cursor-pointer"
